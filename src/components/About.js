    ...
    return (
        <div name='About' className='min-h-full flex items-center h-[600px] w-full bg-slate-100 dark:bg-gray-950'>
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
                ...
                <p className='selection:bg-fuchsia-300 first-letter:text-7xl first-letter:font-bold first-letter:mr-3 first-letter:mt-[-5px] first-letter:float-left text-xl md:mt-0 mt-10 text-gray-950 dark:text-slate-300'>
